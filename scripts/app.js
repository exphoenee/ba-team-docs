...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const routes = {
        ...
        'handbook-ch03': './HANDBOOK/ch03-performance.md',
        'handbook-ch03-en': './HANDBOOK/ch03-performance.en.md',
        'handbook-ch04': './HANDBOOK/ch04-installation.md',
        'handbook-ch04-en': './HANDBOOK/ch04-installation.en.md',
        'handbook-ch05': './HANDBOOK/ch05-folder-structure.md',
        'handbook-ch05-en': './HANDBOOK/ch05-folder-structure.en.md',
        'handbook-ch06': './HANDBOOK/ch06-commands.md',
        'handbook-ch06-en': './HANDBOOK/ch06-commands.en.md',
        'handbook-ch07': './HANDBOOK/ch07-workflow.md',
        'handbook-ch07-en': './HANDBOOK/ch07-workflow.en.md',
        'handbook-ch08': './HANDBOOK/ch08-documents.md',
        'handbook-ch08-en': './HANDBOOK/ch08-documents.en.md',
        'handbook-ch09': './HANDBOOK/ch09-identifiers.md',
        'handbook-ch09-en': './HANDBOOK/ch09-identifiers.en.md',
        'handbook-ch10': './HANDBOOK/ch10-memory.md',
        'handbook-ch10-en': './HANDBOOK/ch10-memory.en.md',
        'handbook-ch11': './HANDBOOK/ch11-file-conversion.md',
        'handbook-ch11-en': './HANDBOOK/ch11-file-conversion.en.md',
        'handbook-ch12': './HANDBOOK/ch12-audio-transcription.md',
        'handbook-ch12-en': './HANDBOOK/ch12-audio-transcription.en.md',
        'handbook-ch13': './HANDBOOK/ch13-special-cases.md',
        'handbook-ch13-en': './HANDBOOK/ch13-special-cases.en.md',
        'handbook-ch14': './HANDBOOK/ch14-diagrams.md',
        'handbook-ch14-en': './HANDBOOK/ch14-diagrams.en.md',
        'handbook-ch15': './HANDBOOK/ch15-notifications.md',
        'handbook-ch15-en': './HANDBOOK/ch15-notifications.en.md',
        'handbook-ch16': './HANDBOOK/ch16-agents.md',
        'handbook-ch16-en': './HANDBOOK/ch16-agents.en.md',
        'handbook-ch17': './HANDBOOK/ch17-compliance.md',
        'handbook-ch17-en': './HANDBOOK/ch17-compliance.en.md',
        'handbook-ch18': './HANDBOOK/ch18-faq.md',
        'handbook-ch18-en': './HANDBOOK/ch18-faq.en.md',
        'handbook-ch19-audio': './HANDBOOK/ch19-troubleshooting.md',
        'handbook-ch19-audio-en': './HANDBOOK/ch19-troubleshooting.en.md',
