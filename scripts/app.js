...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const routes = {
        ...
        "skill-add-answer": "./page/skills/add-answer.md",
        "skill-add-answer-en": "./page/skills/add-answer.en.md",
        "skill-add-decision": "./page/skills/add-decision.md",
        "skill-add-decision-en": "./page/skills/add-decision.en.md",
