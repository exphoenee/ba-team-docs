# 15. Automatic Notifications and Stop Hook
...
This gives an immediate, structured report of all workflow folders, the current phase, and the recommended next step. Details: [Chapter 6 — Commands](ch06-commands.en.md).
