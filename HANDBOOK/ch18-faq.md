...
Hozz létre egy `SDEC-XXX_nev.md` fájlt a `workflow/04_decisions/` mappában. A FORCED döntés felülírja az extraction-agent által levezetett értéket, és `[FORCED]` annotációt kap a specban. Részletek: [7. fejezet — Munkafolyamat](ch07-workflow.md).
