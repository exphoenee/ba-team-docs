...
Create an `SDEC-XXX_name.md` file in the `workflow/04_decisions/` folder. The FORCED decision overrides the value derived by extraction-agent and receives a `[FORCED]` annotation in the spec. Details: [Chapter 6 — Workflow](ch06-workflow.en.md).
