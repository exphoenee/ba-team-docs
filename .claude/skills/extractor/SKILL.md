...
description: >
  ...
  Dispatches the extraction-agent directly (formerly extraction-agent). Use when you want to run only the spec phase
...
Use `/extractor` when you want to regenerate or update the spec without running
