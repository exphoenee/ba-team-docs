# `/extractor` – Specifikáció-készítő

[English version](README.en.md)

## Mire való?

A `/extractor` skill strukturálatlan, nyers emberi kommunikációból — meetingjegyzetekből, emailekből, Slack/Teams üzenetekből, egyeztetési feljegyzésekből — **döntéshozásra alkalmas, strukturált specifikációs csomagot** készít.
...
A `/extractor` intelligensen kezeli a projekt változásait:
...
- A skill mostantól az `extraction-agent`-et dispatchilja (korábban: `spec-builder-agent`). A `/extractor` parancs neve nem változott — a változás belső.
