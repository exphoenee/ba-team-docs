...
A /ba-workflow és a /ba skillek gépi úton ellenőrizik a válaszokat. A rendszer kifejezetten figyeli, hogy a válaszfájlban a kérdés után van-e érdemi szöveg; a "TBD" (később meghatározandó) vagy "N/A" (nem értelmezhető) kifejezéseket nem fogadja el válaszként. Ez kényszeríti ki a precizitást a Business Analystból.
...
- A /ba-workflow és a /ba skillek gépileg ellenőrzik a válaszokat. A rendszer kifejezetten tiltja a "TBD" (később meghatározandó) vagy "N/A" (nem értelmezhető) jellegű rövidítéseket; ezeket nem tekinti érdemi válasznak, és továbbra is megállítja a folyamatot.
...
## /review helyett /preview
Legyen egy skill vagy command ami elkeszíti a ba dokumentumokat, mindegyik elejére tesz egy head ért, hogy ez csak előnézer, és a megválaszolatlan kérdések listáját is bele teszi ebbe.

## File converter fejlesztés
A konvertalt fájlok kapjanak egy headert benne a miből lett konvertálva (fájlnév), az mekkora volt, mikori volt a fájl utolsó módosíta, mi az SHAja. Így könnyen kereshető lesznek.

## /spec-builder fejlesztése
Az informáciokhoz, kérdésekhez, ellentmondásokhoz, kerüljenek be a fájlok SHAja, hogy visszakereshető legyen. 
